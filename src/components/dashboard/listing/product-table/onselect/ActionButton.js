        ...
        <Popover.Pane fixed>
          ...
          <Popover.Section>
            <Tooltip
              content={
                <p>
                  Previously Known as 'Search on Amazon'.
                  <br /> This Functionality checks if your Products barcorde are
                  unique and if they are unique or if they are already available
                  on Amazon
                </p>
              }
            >
